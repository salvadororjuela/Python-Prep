...
# verificando que sean exactamente esa cantidad, y muestre como salida los parámetros 
# recibidos
...
# 3) Crear un archivo a partir de los datos presentes en el diccionario provisto. El
# cual debe contener en la primera fila el nombre de las claves y luego cada línea 
# los elementos i-ésimos de las listas de valores contiguos y separados por coma ','. 
...
for line in montañas.keys():
    if line == "nombre":
        archivo.write(f"{line}: ")
        for i in montañas['nombre']:
            archivo.write(f"{i}, ")
        archivo.write("\n")
        continue
        ...
        archivo.write(f"{line}: ")
        for i in montañas['orden']:
            archivo.write(f"{i}, ")
        archivo.write("\n")
        continue
    
    elif line == "cordillera":
        archivo.write(f"{line}: ")
        for i in montañas['cordillera']:
            archivo.write(f"{i}, ")
        archivo.write("\n")
        continue
...
print(round(os.path.getsize("clase09_ej3.csv")/1024,2))

# 5) Crear una carpeta llamada clase09_montañas_altas
os.makedirs("Mi_carpeta")

# 6) Copiar el archivo clase09_ej3.scv en la carpeta clase09_montañas_altas usando la sentencia ** os.system **
os.system("copy clase09_ej3.csv Mi_carpeta")
